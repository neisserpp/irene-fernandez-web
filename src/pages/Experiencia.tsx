    ...
    <>
          ...
          <div className="lg:col-span-7">
            ...
            {learnings.map((item) => (
              <li key={item} className="flex gap-5 py-6">
                ...
                <p className="font-display text-xl leading-snug text-bone-100">
                  {item}
                </p>
              </li>
            ))}
      ...
      <Section>
        ...
        <div className="mt-14 grid gap-10 lg:grid-cols-12">
          <article className="bg-night-900 p-9 text-bone-100 lg:col-span-7 md:p-12">
          ...
          <div className="space-y-px bg-bone-200 lg:col-span-5">
            {ecosystem.others.map((item) => (
              <article key={item.name} className="bg-bone-100 p-8">
                <h3 className="font-display text-2xl">{item.name}</h3>
                <p className="mt-2 text-xs font-bold tracking-[0.14em] text-petrol-600 uppercase">
                  {item.role}
                </p>
      ...
      <Section tone="bone">
        <div className="flex flex-col items-start justify-between gap-8 md:flex-row md:items-center">
          <h2 className="max-w-xl text-2xl leading-snug md:text-3xl">
            ¿Buscas a alguien con experiencia técnica, criterio empresarial y
            capacidad de liderar personas?
          </h2>
