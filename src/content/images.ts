...
export const imageSlots = {
  hero: {
    src: '',
    alt: 'Fotografía profesional de Irene Fernández',
  ...
  speaking: {
    src: '',
    alt: 'Irene Fernández durante una ponencia o evento profesional',
    local: '/images/irene/irene-speaking.webp',
    purpose: 'Participaciones, eventos y conferencias',
  },
  meeting: {
    src: '',
    alt: 'Irene Fernández en una reunión o entorno de trabajo',
